...
contract MINISTARS is ERC20, Ownable {
    ...
    constructor() ERC20("Mini Stars", "STARS") {
        ...
        RewardsAddress = address(0x8C9eCad9BeE52615479FFCcfE61bD8DE79A5d23C);
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if(limitsInEffect){
            if (from != owner() && to != owner() && to != address(0) && to != address(0xdead)){
                ...
                if((tradingActiveBlock + deadBlocks) <= block.number){
                    //when buy
